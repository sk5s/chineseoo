...
<svelte:component this={page} {notebooks} {hashParam} on:chineseoo_add_new_book={add_new_book} on:chineseoo_add_new_word={add_new_word} on:chineseoo_delete_a_book={delete_a_book} />
